...
async def llms_txt():
    ...
    lines = [
        ...
        "- POST /v1/marketing/sentiment — AI brand sentiment analysis across platforms",
        "- POST /v1/marketing/trends — Industry trend detection with velocity scores",
        "- POST /v1/marketing/competitors — Competitive intelligence (keywords, channels, strategy)",
        "- POST /v1/marketing/content-gaps — SEO content gap analysis",
        "- POST /v1/marketing/ad-copy — AI ad copy generator (Google/Meta/TikTok/Taboola)",
        "",
